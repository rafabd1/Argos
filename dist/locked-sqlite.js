...
exports.withArgosFileLock = withArgosFileLock;
...
function withArgosFileLock(lockDir, action) {
...
class SqliteFileLock {
    ...
    removeReusableLock() {
        ...
        if (owner.pid && isProcessAlive(owner.pid))
            return;
        if (ageMs < ORPHAN_LOCK_GRACE_MS && ageMs < LOCK_STALE_MS)
            return;
        try {
            node_fs_1.default.rmSync(this.lockDir, { recursive: true, force: true, maxRetries: 5, retryDelay: 25 });
        }
